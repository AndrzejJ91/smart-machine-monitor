...
const Profileinfo = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserStatus = async () => {
            ...
            try {
                ...
                console.error("Błąd podczas pobierania statusu użytkownika:", error);
    ...
    return (
        <div className="relative bg-gray-800 text-white w-full h-full flex p-8 rounded-xl shadow-md">
            {/* Profilowy awatar i podstawowe dane */}
            ...
            {/* Aktywny status na prawej stronie */}
